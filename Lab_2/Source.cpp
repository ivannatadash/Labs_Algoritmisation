/*З клавіатури ввести матрицю дійсних чисел. */
/*Розробити функцію яка вилучає із заданої матриці дійсних чисел рядки в яких мінімальний елемент не є першим і повертає кількість вилучених рядків.*/
/*Вилучення рядка полягає у підтягуванні всіх наступних рядків догори.*/
/*На основі розробленої функції перевірити рядки введеної матриці та вилучити ті що не відповідають умові.*/
/* Надрукувати матрицю після і вказати кількість видалених рядків.*/
